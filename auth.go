...
func JwtGetUser(req *http.Request) (*User, error) {
	u := new(User)
...
func ApiUserLogin(r render.Render, w http.ResponseWriter, req *http.Request, user User) {
...
func ApiUserSignup(w http.ResponseWriter, req *http.Request, r render.Render, user User) {
	user.Username = strings.ToLower(user.Username)
